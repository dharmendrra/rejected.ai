	...
	turns := []domain.Turn{
		{
			...
			Hint:               "Consider discussing key components like queueing, partitioning, backpressure, and analytical databases.",
		...
		},
		{
			...
			Hint:               "Mention idempotency keys, deduping caches, and how you process failures (e.g. DLQs).",
		...
		},
		{
			...
			Hint:               "Talk about prioritization matrices, business/developer alignment, and dedicated sprint budget.",
	...
	turns2 := []domain.Turn{
		{
			...
			Kind:               domain.TurnQuestion,
			Question:           "Explain a time when you had to design a highly scalable data ingestion system.",
			Hint:               "Describe the choices made between simple relational database writes versus message brokers.",
			TargetCompetencies: []string{"System Architecture"},
		...
		},
		{
			...
			Kind:               domain.TurnQuestion,
			Question:           "How did you handle consistency issues and failures in that ingestion pipeline?",
			Hint:               "Discuss options for handling duplicate event processing and network retries.",
			TargetCompetencies: []string{"Scalability & Reliability"},
		...
		},
		{
			...
			Kind:               domain.TurnQuestion,
			Question:           "How do you evaluate and prioritize technical debt when leading engineering teams?",
			Hint:               "Focus on tracking team velocity, developer friction, and refactoring guidelines.",
			TargetCompetencies: []string{"Technical Leadership"},
	...
	turns3 := []domain.Turn{
		{
			...
			Hint:               "Think about standard conflict resolution techniques (data-driven decisions, trade-off proposals).",
		...
		},
		{
			...
			Hint:               "Consider discussing delegation of ownership, code review best practices, and pair programming.",
